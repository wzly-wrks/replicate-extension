 ...
 * Browser-compatible version using SillyTavern globals
 */
...
(function () {
    ...
    function ensureState() {
        ...
        if (!settings) {
            const existing = context.extensionSettings[MODULE_KEY] ?? {};
            settings = { ...defaultSettings, ...existing };
            context.extensionSettings[MODULE_KEY] = settings;
        }
    ...
    function setupEventHandlers() {
        ...
        context.eventSource.on(context.event_types.EXTENSION_SETTINGS_LOADED, () => {
            refreshState();
            renderSettingsPanel();
        });
    ...
    if (typeof SillyTavern !== 'undefined') {
        ...
        console.error('[Replicate Extension] SillyTavern global object not found!');
    }
